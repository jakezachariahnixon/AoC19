...
def day_three_part_one():
    ...
    for move in route1:
        ...
        if dir == 'R':
            for i in range(1, count + 1):
                pos_history.append((pos[0] + i, pos[1]))
            ...
            for i in range(1, count + 1):
                pos_history.append((pos[0], pos[1] + i))
    ...
    closest_collision = collision_history[0]
    for collision in collision_history:
        if (collision[0] + collision[1]) < (closest_collision[0] + closest_collision[1]):
